...
package org.wso2.carbon.identity.rest.api.user.session.v1.impl.core;
...
public class SessionManagerService {
    ...
    private static UserSessionManagementService sessionManager = UserSessionManagementService.getInstance();
