...
package org.wso2.carbon.identity.rest.api.user.challenge.v10.core;
...
import org.wso2.carbon.identity.rest.api.user.challenge.v10.dto.ChallengeQuestionDTO;
import org.wso2.carbon.identity.rest.api.user.challenge.v10.dto.ChallengeQuestionPatchDTO;
...
import static org.wso2.carbon.identity.rest.api.user.challenge.v10.core.Constants.OPERATION_ADD;
...
//                .collect( Collectors.toList() );
    ...
    private static Map<String, List<ChallengeQuestion>> groupChallenges(List<ChallengeQuestion> challengeQuestions) {
        return challengeQuestions.stream()
                .collect(groupingBy(question -> question.getQuestionSetId().split(WSO2_CLAIM_DIALECT)[1])).entrySet()
